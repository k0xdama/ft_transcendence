	...
	return (
		<div className="absolute bottom-6 right-6 z-10 flex gap-3">
			{BUZZERS.map(({ name, label }) => (
				<button
					key={name}
					className="flex h-[52px] w-[52px] cursor-pointer items-center justify-center rounded-full border-2 border-[rgba(180,60,255,0.4)] bg-[radial-gradient(circle_at_40%_35%,rgba(40,10,60,0.9),rgba(10,5,20,0.95))] text-[1.4rem] text-white shadow-[0_0_12px_rgba(140,40,200,0.25),inset_0_-3px_6px_rgba(0,0,0,0.4)] transition-[transform,box-shadow,border-color] duration-150 ease-in-out hover:scale-[1.12] hover:border-[rgba(0,220,255,0.6)] hover:shadow-[0_0_20px_rgba(0,200,255,0.35),inset_0_-3px_6px_rgba(0,0,0,0.4)] active:scale-[0.92] active:shadow-[0_0_8px_rgba(180,60,255,0.5),inset_0_2px_8px_rgba(0,0,0,0.6)]"
